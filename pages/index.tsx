...
const Home = ({ pageInfo, experiences, skills, projects, socials }: Props) => {
  return (
    <div className="z-0 h-screen overflow-x-hidden overflow-y-scroll text-white bg-slate-700 snap-y snap-mandatory scrollbar scrollbar-track-gray-400/30 scrollbar-thumb-yellow-300/80">
      <Head>
