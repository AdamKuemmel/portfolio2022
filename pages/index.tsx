...
const Home = ({ pageInfo, experiences, skills, projects, socials }: Props) => {
  return (
    <div className="z-0 h-screen overflow-x-hidden overflow-y-scroll text-white bg-[#0c0c0c] snap-y snap-mandatory scrollbar scrollbar-track-gray-400/30 scrollbar-thumb-[#edf1cf]/80">
      <Head>
